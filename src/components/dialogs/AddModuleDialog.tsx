...
export function AddModuleDialog({ open, onOpenChange, onAdd, onEdit, initialData, professors }: AddModuleDialogProps) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        const moduleData = {
            ...(initialData || {
                ...
                examsPlanned: 0,
                groups: ["G1"], // Default
                department: "Informatique", // Default for now
                color: "bg-primary"
            }),
            code: formData.code,
            name: formData.name,
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-[425px]">
                <DialogHeader>
                    <DialogTitle>{initialData ? "Modifier le module" : "Ajouter un module"}</DialogTitle>
                    <DialogDescription>
                        {initialData ? "Modifiez les informations du module" : "Remplissez les informations du nouveau module"}
                    </DialogDescription>
                </DialogHeader>
